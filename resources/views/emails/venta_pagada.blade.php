                    ...
                    <tr>
                        <td style="padding:30px 25px;">
                            ...
                            <h2 style="color:#333; margin-top:0;">
                                ¡Hola {{ $venta->referido->nombre }}!
                            </h2>

                            <p style="font-size:16px; line-height:1.6;">
                                ¡Buenas noticias! Una de tus ventas ha sido
                                <strong style="color:#28a745;">pagada exitosamente</strong>.
                            </p>
                            ...
                            <p style="font-size:15px;">
                                ...
                                ¡Sigue compartiendo tu enlace para seguir generando ingresos!
                            </p>
